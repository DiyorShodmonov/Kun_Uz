...
public class CommentService {
    ...
    public Boolean delete(Integer id, ProfileResponseDTO profile, Language language) {
        ...
        if (!entity.getProfileId().equals(profile.getId()) && profile.getRole() != ProfileRole.ADMIN) {
            throw new OnlyOwnerCaneUpdate(resourceBundleService.getMessage("owner", language));
        }
